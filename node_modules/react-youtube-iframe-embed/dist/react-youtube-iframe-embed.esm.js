...
var FlexEmbed = function (_Component) {
  ...
  _createClass(FlexEmbed, [{
    ...
    value: function render() {
      ...
      return React.createElement(Block, _extends({ overflow: 'hidden', position: 'relative' }, props), React.createElement(Block, { width: '100%', paddingBottom: percentage || ratio * 100 + '%' }), React.createElement(Block, {
        top: '0',
        left: '0',
        props: { ref: setRef },
        width: '100%',
...
var _createContext = createContext(defaultValue),
...
export { YouTubeIframeAPIProvider };
//# sourceMappingURL=react-youtube-iframe-embed.esm.js.map
